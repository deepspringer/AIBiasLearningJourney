...
const AlgorithmicBiasApp = () => {
  ...
  const [messages, setMessages] = useState<Message[]>([
    {
      role: "assistant",
      content: "Welcome to the Algorithmic Bias Learning Platform! I'm here to guide you through understanding algorithmic bias. Let's start by exploring some key concepts. Ready to begin?",
    },
  ]);
  ...
  useEffect(() => {
    ...
    if (messages.length > 1) { // Don't add on initial load
      ...
      switch (currentPhase) {
        case 1:
          phaseMessage = "We're now in the learning phase. Let's explore the concept of algorithmic bias paragraph by paragraph. Take your time to read each section, and I'll help you understand the key points.";
          break;
        case 2:
          phaseMessage = "Now we're in the experimentation phase. You can use the tool to create template sentences and see how language models respond differently to various demographic terms. Try creating some templates and we'll analyze the results together.";
          break;
        case 3:
          phaseMessage = "It's time to write your conclusion based on what you've learned. What were your key takeaways from the reading and experiments? What surprised you about algorithmic bias?";
          break;
      }
      ...
      <header className="bg-white shadow-sm">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <h1 className="text-2xl font-bold text-primary">Algorithmic Bias Learning Platform</h1>
            <PhaseNavigation 
      ...
      <footer className="bg-white border-t border-gray-200 py-4">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center">
            <p className="text-sm text-gray-500">© {new Date().getFullYear()} Algorithmic Bias Learning Platform</p>
            <div>
